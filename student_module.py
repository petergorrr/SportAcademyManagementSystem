...
def student_menu():
    student_id = None  # Initialize student_id to None
    while True:
        print("\nStudent Menu:")
    ...
    while True:
        ...
        for student in registered_students:
            ...
            if data[0] == student_id and data[-1] == password:
                ...
                return student_id  # Return student_id if login is successful
...
def provide_feedback_and_ratings(student_id):
    coach_id = input(
        "Enter Coach ID you want to provide feedback for: ").strip()
    ...
    # Append feedback and rating to the feedback file
...
def view_sport_details():
    ...
    print("\nSport Details:")
    for sport in sports:
        sport_id, sport_name = sport.split(',')
...
def view_registered_sport_schedule(student_id):
    ...
    for student in registered_students:
        ...
        if data[0] == student_id:
            student_schedule = data[-2]
            print(f"\nYour Sport Schedule: {student_schedule}")
            return
...
def modify_self_record(student_id):
    ...
    for student in registered_students:
        ...
        if data[0] == student_id:
            ...
            sport = input(
                "Enter updated Sport (press Enter to keep existing): ")
            coach = input(
                "Enter updated Coach (press Enter to keep existing): ")
            schedule = input(
                "Enter updated Schedule (press Enter to keep existing): ")
